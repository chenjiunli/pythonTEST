...
ANOMALY_FILE = "oht_v2_anomaly_data.pkl"  
...
if is_data_ready:
    ...
    if os.path.exists(ANOMALY_FILE):
        ...
        if not anomaly_df_display.empty:
            ...
            st.dataframe(anomaly_df_display, width='stretch', hide_index=True)
        else:
    ...
    if os.path.exists(PROG_FILE):
        ...
        with p_col1:
            st.dataframe(prog_df_display, width='stretch', hide_index=True)
        st.markdown("---")
